"""Reusable helpers for local recyclable-material image data."""
...
def extract_zip_archive(archive_path: str | Path, output_dir: str | Path) -> Path:
    """Extract a zip archive and return the output directory."""
