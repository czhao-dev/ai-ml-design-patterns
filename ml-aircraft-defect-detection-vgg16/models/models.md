...
| File | Model |
|---|---|
| `vgg16_feature_extraction_aircraft_damage_classifier.keras` | VGG16 with a frozen convolutional base (feature extraction) |
| `vgg16_fine_tuned_aircraft_damage_classifier.keras` | VGG16 fine-tuned from `block5_conv3` onward |
